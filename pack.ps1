...
cd NiL.JS
dotnet build -c Release -property:VersionPrefix=2.5.$(git rev-list --count develop) -property:SignAssembly=true
dotnet pack -c Release -property:VersionPrefix=2.5.$(git rev-list --count develop) -property:SignAssembly=true
