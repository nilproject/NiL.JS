...
namespace NiL.JS.Expressions
{
    ...
    [Serializable]
#endif
    public sealed class NumberMoreOrEqualOperator : Expression
    {
        ...
        public NumberMoreOrEqualOperator(Expression first, Expression second)
        ...
        internal protected override JSValue Evaluate(Core.Context context)
        {
            ...
            else
            {
                ...
                temp.Assign(op);
                tempContainer = null;
                var res = !LessOperator.Check(temp, second.Evaluate(context), true);
                tempContainer = temp;
                return res;
            }
        }
