...
namespace NiL.JS.Expressions
{
    ...
    public class More : Expression
    {
        ...
        public override JSValue Evaluate(Context context)
        {
            ...
            tempContainer = temp;
            if (tempContainer._valueType == JSValueType.Integer && s._valueType == JSValueType.Integer)
            {
                tempContainer._valueType = JSValueType.Boolean;
                tempContainer._iValue = tempContainer._iValue > s._iValue ? 1 : 0;
