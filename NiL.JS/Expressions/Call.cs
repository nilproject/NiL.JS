...
namespace NiL.JS.Expressions
{
    ...
    public sealed class Call : Expression
    {
        ...
        private static void checkStackInternal(decimal a = 0, decimal b = 0, decimal c = 0, decimal d = 0, decimal e = 0, decimal f = 0, decimal g = 0, decimal h = 0, decimal i = 0, decimal j = 0, decimal k = 0, decimal l = 0)
        {
#if !PORTABLE && !NET35
