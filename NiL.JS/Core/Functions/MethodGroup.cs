...
namespace NiL.JS.Core.Functions
{
    ...
    internal sealed class MethodGroup : BaseLibrary.Function
    {
        ...
        public MethodGroup(MethodProxy[] methods)
        {
            ...
            _length = new BaseLibrary.Number(len) { attributes = JSObjectAttributesInternal.ReadOnly | JSObjectAttributesInternal.DoNotDelete | JSObjectAttributesInternal.DoNotEnumerate };
