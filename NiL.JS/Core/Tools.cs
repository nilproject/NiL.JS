...
namespace NiL.JS.Core
{
    ...
    public sealed class CodeCoordinates
    {
        ...
        public CodeCoordinates(string code, int line, int column)
        {
            Code = code;
            Line = line;
            Column = column;
        ...
        public static CodeCoordinates FromTextPosition(string text, int position)
        {
            ...
            string code = text.Substring(startPosition, endPosition - startPosition).Trim();

            return new CodeCoordinates(code, line, column);
        }
    }
